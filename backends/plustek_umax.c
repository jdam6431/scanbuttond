...
int plustek_match_libusb_scanner(libusbi_device_t* device)
{
	int index;
...
void plustek_attach_libusb_scanner(libusbi_device_t* device)
{
...
void plustek_scan_devices(libusbi_device_t* devices)
{
	int index;
