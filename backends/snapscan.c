...
int snapscan_match_libusb_scanner(libusbi_device_t* device)
{
	int index;
...
void snapscan_attach_libusb_scanner(libusbi_device_t* device)
{
...
void snapscan_scan_devices(libusbi_device_t* devices)
{
	int index;
