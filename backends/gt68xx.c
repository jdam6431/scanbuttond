...
int gt68xx_match_libusb_scanner(libusbi_device_t* device)
{
	int index;
...
void gt68xx_attach_libusb_scanner(libusbi_device_t* device)
{
...
void gt68xx_scan_devices(libusbi_device_t* devices)
{
	int index;
